...
type GreetWithTimeoutRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWithTimeoutRequest) Reset() {
	*x = GreetWithTimeoutRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithTimeoutRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithTimeoutRequest) ProtoMessage() {}

func (x *GreetWithTimeoutRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithTimeoutRequest.ProtoReflect.Descriptor instead.
func (*GreetWithTimeoutRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{9}
}

func (x *GreetWithTimeoutRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
type GreetWithTimeoutResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWithTimeoutResponse) Reset() {
	*x = GreetWithTimeoutResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithTimeoutResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithTimeoutResponse) ProtoMessage() {}

func (x *GreetWithTimeoutResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithTimeoutResponse.ProtoReflect.Descriptor instead.
func (*GreetWithTimeoutResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{10}
}

func (x *GreetWithTimeoutResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74,
	...
	0x74, 0x57, 0x69, 0x74, 0x68, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x1e, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x54, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x54, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetWithTimeoutRequest)(nil),  // 9: greet.GreetWithTimeoutRequest
	(*GreetWithTimeoutResponse)(nil), // 10: greet.GreetWithTimeoutResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0,  // 4: greet.GreetWithTimeoutRequest.greeting:type_name -> greet.Greeting
	...
	9,  // 9: greet.GreetService.GreetWithTimeout:input_type -> greet.GreetWithTimeoutRequest
	...
	10, // 14: greet.GreetService.GreetWithTimeout:output_type -> greet.GreetWithTimeoutResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithTimeoutRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greet_greetpb_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithTimeoutResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetServiceClient interface {
	...
	// GreetWithTimeout
	GreetWithTimeout(ctx context.Context, in *GreetWithTimeoutRequest, opts ...grpc.CallOption) (*GreetWithTimeoutResponse, error)
}
...
func (c *greetServiceClient) GreetWithTimeout(ctx context.Context, in *GreetWithTimeoutRequest, opts ...grpc.CallOption) (*GreetWithTimeoutResponse, error) {
	out := new(GreetWithTimeoutResponse)
...
type GreetServiceServer interface {
	...
	// GreetWithTimeout
	GreetWithTimeout(context.Context, *GreetWithTimeoutRequest) (*GreetWithTimeoutResponse, error)
}
...
func (*UnimplementedGreetServiceServer) GreetWithTimeout(context.Context, *GreetWithTimeoutRequest) (*GreetWithTimeoutResponse, error) {
...
func _GreetService_GreetWithTimeout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetWithTimeoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithTimeout(ctx, req.(*GreetWithTimeoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
